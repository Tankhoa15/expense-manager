...
public class MoneySourceController {
    ...
    public ResponseEntity<ApiResponse<MoneySourceResponse>> create(
        ...
        MoneySourceResponse source = moneySourceService.create(userPrincipal.getId(), request);
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success("Money source created", source));
    }
    ...
    public ResponseEntity<ApiResponse<MoneySourceResponse>> update(
        ...
        return ResponseEntity.ok(ApiResponse.success("Money source updated", source));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> delete(
        ...
        return ResponseEntity.ok(ApiResponse.success("Money source deleted", null));
    }
}
